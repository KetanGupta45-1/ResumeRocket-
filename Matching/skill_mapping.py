skill_mapping = {
    ...
    'neural networks': 'deep learning', 'natural language processing': 'nlp', 'nlp': 'natural language processing',
    'computer vision': 'computer vision', 'tensorflow': 'tensorflow', 'pytorch': 'pytorch',
    
    'keras': 'keras', 'scikit-learn': 'scikit learn', 'scikit learn': 'scikit learn', 'dl' : 'deep learning',
